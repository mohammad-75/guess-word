...
function new_word(form)
{
  ...
  else advise("این کلمه موجود میباشد");
}
function seek(letter)
{
  if (!running) advise("کلیک کنید برای شروع !");
  else
  {
    t=0;
    ...
    if (!t)
    {
      ...
      if (failnum==6)
      {
        document.f.tried.value="باختی دوباره امتحان کن";
    ...
    else advise("موجود است"+letter+"حرف");
  }
}
function advise(msg)
{
